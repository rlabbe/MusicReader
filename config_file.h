...
public:
    ...
    void set_file_version(int value)
    {
        file_version_ = value;
        save();
    }
    ...
    void set_restore_window_position(bool value)
    {
        restore_window_position_ = value;
        save();
    }

    bool restore_documents() const { return restore_documents_; }
    void set_restore_documents(bool value)
    {
        restore_documents_ = value;
        save();
    }

    bool zoom_to_content() const { return zoom_to_content_; }
    void set_zoom_to_content(bool value)
    {
        zoom_to_content_ = value;
        save();
    }
    ...
    {
        show_status_bar_ = value;
        save();
    }

    bool show_toolbar() const { return show_toolbar_; }
    void set_show_toolbar(bool value)
    {
        show_toolbar_ = value;
        save();
    }
    ...
    void set_horiz_tabs(bool value)
    {
        horiz_tabs_ = value;
        save();
    }
    ...
    void set_allow_file_delete(bool value)
    {
        allow_file_delete_ = value;
        save();
    }
    ...
    void set_recent_documents(const std::vector<std::filesystem::path>& value)
    {
        recent_documents_ = value;
        save();
    }

    // [x, y, sx, sy]
    const std::array<int, 4>& app_size() const { return app_size_; }
    void set_app_size(const std::array<int, 4>& value)
    {
        app_size_ = value;
        save();
    }
    ...
    void set_dev_size(const std::array<int, 4>& value)
    {
        dev_dialog_size_ = value;
        save();
    }
    ...
    void set_toolbar_location(ToolbarLocation value)
    {
        toolbar_location_ = value;
        save();
    }
    ...
    void set_page_view_count(int value)
    {
        page_view_count_ = value;
        save();
    }

    int page_step_size() const { return page_step_size_; }
    void set_page_step_size(int value)
    {
        page_step_size_ = value;
        save();
    }

    void toggle_page_step_size()
    {
        page_step_size_ = (page_step_size_ == 1) ? 2 : 1;
        save();
    }

    // -1 or >=0
    int open_tab() const { return open_tab_; }
    void set_open_tab(int value)
    {
        open_tab_ = value;
        save();
    }
    ...
    void set_max_recent_documents(int value)
    {
        max_recent_documents_ = value;
        save();
    }

    int save_cadence_secs() const { return save_cadence_secs_; }
    void set_save_cadence_secs(int value)
    {
        save_cadence_secs_ = value;
        save();
    }
    ...
    void set_allow_oversize(bool value)
    {
        allow_oversize_ = value;
        save();
    }
    ...
    void set_border_margin(int value)
    {
        border_margin_ = value;
        save();
    }

    const std::filesystem::path& music_directory() const { return music_directory_; }
    void set_music_directory(const std::filesystem::path& value)
    {
        music_directory_ = value;
        save();
    }
    ...
    void set_tour_has_run(bool value)
    {
        tour_has_run_ = value;
        save();
    }
    ...
    void set_append_to_log(bool value)
    {
...
public:
    ConfigFileGroupSave(ConfigFile& config)
        : config_(config)
    {
        config.start_group_changes();
    }
