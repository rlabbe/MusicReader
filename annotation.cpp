...
Annotation::Annotation(const std::string &text, int page_num, float x, float y, float width, float height, const FontInfo &font_info)
                ...
                if (pdf_name_eq(ctx, subtype, PDF_NAME(FreeText))) {
                    ...
                    if (rect && contents) {
                        ...
                        if (text && strlen(text) > 0) {
                            ...
                            logger::debug("LOAD: page={}, x={}, y={}, w={}, h={}, text='{}', font='{}' {}pt, color=({},{},{})",
